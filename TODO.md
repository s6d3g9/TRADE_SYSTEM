...
- [x] Сайдбар очищен от лишних разделов: оставлен только рабочий пункт `Bots + Backtests`.
- [x] Topbar очищен от нерабочих кнопок и лишних route-ярлыков, оставлен фокус на рабочем workspace.
- [x] Рабочая страница бэктестов перестроена: сверху график + справа выбор биржи/пар с набором, ниже параметры интервала и стратегии + запуск серии бэктестов.
