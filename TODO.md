...
## In Progress (Фаза 2: Слой Данных)
- [ ] Рефакторинг `backend/app/models/trading.py` (применение `TimestampMixin`, проверка связей).
- [ ] Рефакторинг `backend/app/models/strategylab.py`.
